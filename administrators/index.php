...
<?php foreach ($administrators as $administrator) : ?>
	<tr>
		...
		<td><?php echo $administrator['photo']; ?></td>
		<td><?php echo $administrator['name']; ?></td>
		<td><?php echo $administrator['cpf']; ?></td>
		<td><?php echo $administrator['mail']; ?></td>
		<td><?php echo $administrator['phone']; ?></td>
		<td><?php echo $administrator['mobile']; ?></td>
		<td><?php echo $administrator['modified']; ?></td>
		<td class="actions text-right">
			<a href="view.php?id=<?php echo $administrator['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Visualizar</a>
			<a href="edit.php?id=<?php echo $administrator['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Editar</a>
			<a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-administrator" data-administrator="<?php echo $administrator['id']; ?>">
